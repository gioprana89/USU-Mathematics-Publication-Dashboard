...
# =====================================================
st.set_page_config(
    page_title="Publication Data Access Dashboard",
    page_icon="📚",
    layout="wide"
)
...
st.title("📚 Publication Analytics Dashboard for Mathematics Lecturers at Universitas Sumatera Utara")
st.caption(
    "Interactive dashboard for accessing lecturer publication data, filtering by lecturer, "
    "publication type, year, and Scopus index status, with summary tables and publication-style charts."
)
...
def find_default_dataset():
    candidates = [
        Path("data publikasi.xlsx"),
        Path(__file__).parent / "data publikasi.xlsx" if "__file__" in globals() else Path("data publikasi.xlsx"),
    ]
...
tab_detail, tab_summary, tab_chart, tab_export = st.tabs([
    "📄 Detail Publikasi",
    "📊 Tabel Rekap",
    "📈 Visualisasi",
    "⬇️ Download"
